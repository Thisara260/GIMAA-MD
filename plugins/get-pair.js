...
/**
 * Fetches a pairing code for the GIMAA-MD bot.
...
malvin({
    ...
    react: '✅',
    desc: 'Get pairing code for GIMAA-MD bot',
    category: 'download',
    use: '.pair 947043xxx',
    filename: __filename
    ...
    try {
        ...
        // Make API request
        const response = await axios.get(`https://gimaa-md-v1-0-1.onrender.com/code?number=${encodeURIComponent(phoneNumber)}`);
