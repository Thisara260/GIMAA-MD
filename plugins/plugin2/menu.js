...
malvin({
    ...
    try {
        // Time and date info
        const timezone = config.TIMEZONE || 'Sri Lanka/Colombo';
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo
            },
            { quoted: mek }
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['1'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['2'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['3'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['4'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['5'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['6'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['7'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['8'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['9'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['10'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['11'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['12'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['13'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
...
`;
        ...
        await malvin.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGES?.['14'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg' },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
