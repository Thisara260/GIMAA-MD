...
malvin({
  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(config.MENU_IMAGE_URL || "https://i.ibb.co/x8hP1DR4/shaban-md.jpg", {
      ...
      await malvin.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "GIMAA-MD",
            body: config.DESCRIPTION || "POWERED BY GIMAA",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/medum3", // Static image URL
            sourceUrl: "https://wa.me/94704198014",
