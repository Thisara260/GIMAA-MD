...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['1'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '2': {
                title: "👥 *Group Menu* 👥",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['2'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '3': {
                title: "😄 *Fun Menu* 😄",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['3'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '4': {
                title: "👑 *Owner Menu* 👑",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['4'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '5': {
                title: "🤖 *AI Menu* 🤖",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['5'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '6': {
                title: "🎎 *Anime Menu* 🎎",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['6'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '7': {
                title: "🔄 *Convert Menu* 🔄",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['7'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '8': {
                title: "📌 *Other Menu* 📌",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['8'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '9': {
                title: "💞 *Reaction Menu* 💞",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['9'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '10': {
                title: "🏠 *Main Menu* 🏠",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['10'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '11': {
                title: "🎨 *Logo Maker* 🎨",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['11'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '12': {
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['12'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '13': {
                title: "🎵 *Audio Menu* 🎵",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['13'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            },
            '14': {
                title: "🔒 *Privacy Menu* 🔒",
                content: `
...
> ${config.DESCRIPTION}`,
                image: true,
                imageUrl: config.MENU_IMAGES?.['14'] || config.MENU_IMAGE_URL || 'https://i.ibb.co/x8hP1DR4/shaban-md.jpg'
            }
        };
