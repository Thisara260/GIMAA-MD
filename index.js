...
async function connectToWA() {
  ...
  console.log("Connecting Gimaa-MD");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("Gimaa-MD installed successful ✅");
      console.log("Gimaa-MD connected to whatsapp ✅");

      let up = `Gimaa-MD connected successful ✅`;
      let up1 = `Hello Gimaa, I made bot successful`;
